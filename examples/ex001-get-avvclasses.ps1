...
#Params с ключом Constructor
Write-Host "Params contain key 'Constructor' ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
#(Get-AvvClass -ClassName avvTest -Params @{"constructor"=@{"param1"=@{"type"="Str"; "value"="ttt"}; "param0"=@{"type"="int";"value"=10}}} -Verbose:$Ve)|ConvertTo-Json -Depth 100
Write-Host "++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
...
#$global:f=(Get-AvvClass -ClassName avvTest -Params @{"_obj_"=@{"f1"=@{"f1_1"=1;"f1_2"=2};"id"="id1"; "f2"=12; "fg"=444};} -Verbose:$Ve); $f|ConvertTo-Json -Depth 100
Write-Host "++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"

#Params с ключом _obj_add_
Write-Host "Params contains keys '_obj_add_' ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
#$global:f=(Get-AvvClass -ClassName avvTest -Params @{"_obj_add_"=@{"f1"=@{"f1_1"=1;"f1_2"=2};"id"="id1"; "f2"=@{}; "fg"=444};} -Verbose:$Ve); $f|ConvertTo-Json -Depth 100
Write-Host "++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"

#Params с ключом _obj_add_value_
Write-Host "Params contains keys '_obj_add_value_' ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
#$global:f=(Get-AvvClass -ClassName avvTest -Params @{"_obj_add_value_"=@{"f3"=100; "fg"=444; "f1"="_as_"; "f2"=@{"ff1"="ggg"; "ff2"=34545}}} -Verbose:$Ve); $f|ConvertTo-Json -Depth 100
Write-Host "++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
...
$global:f=(Get-AvvClass -ClassName avvTest -Params @{"_new_"=@{"f1_1"=1;"f1_2"=2; "id"=1; "tst"=@{f1=1;f2=2}; "f1"="asd"; "f2"=@{"b1"=1;"b2"=2}}; "fg"=444} -Verbose:$Ve); $f|ConvertTo-Json -Depth 100
Write-Host "++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
